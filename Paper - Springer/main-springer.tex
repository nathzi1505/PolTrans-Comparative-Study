...
\newcommand{\changesA}[1]{\textcolor{black}{#1}}
\newcommand{\changesB}[1]{\textcolor{black}{#1}}
...
\title{Empirical Assessment of Transformer Based Neural Network Architecture in Forecasting Pollution Trends}

\author{Pritthijit Nath \and 
    Asif Iqbal Middya \and
    Sarbani Roy 
}
...
\institute{ Pritthijit Nath \at Dept. of Computer Science and Engineering \\
                        Jadavpur University, Kolkata, India \\
              \email{pritthijit.nath@ieee.org} 
              \and          
          Asif Iqbal Middya \at
              Dept. of Computer Science and Engineering \\
              Jadavpur University, Kolkata, India \\
              \email{asifim.rs@jadavpuruniversity.in}   
         \and
          Sarbani Roy (Corresponding Author) \at
              Dept. of Computer Science and Engineering \\
              Jadavpur University, Kolkata, India \\
...
\begin{figure}[h]
\centering
\includegraphics[width=8.5cm]{./merged_taylor_m_stat.png}
...
\begin{figure*}[h]
\centering
\includegraphics[width=16cm]{./ts-lineplot.png}
